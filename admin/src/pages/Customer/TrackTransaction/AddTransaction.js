...
const customer = User.getCurrent();
...
class Transaction extends Component {
  ...
  render() {
    ...
    return (
      <div className="animated fadeIn pt-5 pb-5">
        <Container>
          <Row>
            <Col xs={12} style={{minHeight: 50}}>
              ...
              />
              <Button className="btn-success animated fadeIn fadeOut" onClick={() => this.handleSubmitTransaction()}>
                Submit
              </Button>
            </Col>
          </Row>
